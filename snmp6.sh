...
do
   now=$(date +"%H:%M")
   UNERRORED=$(snmpwalk -v 2c -c $SNMP_PWD $IP .1.3.6.1.2.1.10.127.1.1.4.1.2.$IFINDEX1)
   UNERRORED=$(sed "s/SNMPv2-SMI::transmission.127.1.1.4.1.2.$IFINDEX1 = Counter32: /,/g" <<< "$UNERRORED")
   CORRECTED=$(snmpwalk -v 2c -c $SNMP_PWD $IP .1.3.6.1.2.1.10.127.1.1.4.1.3.$IFINDEX1)
   CORRECTED=$(sed "s/SNMPv2-SMI::transmission.127.1.1.4.1.3.$IFINDEX1 = Counter32: /,/g" <<< "$CORRECTED")
   UNCORRECTED=$(snmpwalk -v 2c -c $SNMP_PWD $IP .1.3.6.1.2.1.10.127.1.1.4.1.4.$IFINDEX1)
   UNCORRECTED=$(sed "s/SNMPv2-SMI::transmission.127.1.1.4.1.4.$IFINDEX1 = Counter32: /,/g" <<< "$UNCORRECTED")
   SNR=$(snmpwalk -v 2c -c $SNMP_PWD $IP .1.3.6.1.2.1.10.127.1.1.4.1.5.$IFINDEX1)
   ...
   UNERRORED=$(snmpwalk -v 2c -c $SNMP_PWD $IP .1.3.6.1.2.1.10.127.1.1.4.1.2.$IFINDEX2)
   UNERRORED=$(sed "s/SNMPv2-SMI::transmission.127.1.1.4.1.2.$IFINDEX2 = Counter32: /,/g" <<< "$UNERRORED")
   CORRECTED=$(snmpwalk -v 2c -c $SNMP_PWD $IP .1.3.6.1.2.1.10.127.1.1.4.1.3.$IFINDEX2)
   CORRECTED=$(sed "s/SNMPv2-SMI::transmission.127.1.1.4.1.3.$IFINDEX2 = Counter32: /,/g" <<< "$CORRECTED")
   UNCORRECTED=$(snmpwalk -v 2c -c $SNMP_PWD $IP .1.3.6.1.2.1.10.127.1.1.4.1.4.$IFINDEX2)
   UNCORRECTED=$(sed "s/SNMPv2-SMI::transmission.127.1.1.4.1.4.$IFINDEX2 = Counter32: /,/g" <<< "$UNCORRECTED")
   SNR=$(snmpwalk -v 2c -c $SNMP_PWD $IP .1.3.6.1.2.1.10.127.1.1.4.1.5.$IFINDEX2)
   ...
   UNERRORED=$(snmpwalk -v 2c -c $SNMP_PWD $IP .1.3.6.1.2.1.10.127.1.1.4.1.2.$IFINDEX3)
   UNERRORED=$(sed "s/SNMPv2-SMI::transmission.127.1.1.4.1.2.$IFINDEX3 = Counter32: /,/g" <<< "$UNERRORED")
   CORRECTED=$(snmpwalk -v 2c -c $SNMP_PWD $IP .1.3.6.1.2.1.10.127.1.1.4.1.3.$IFINDEX3)
   CORRECTED=$(sed "s/SNMPv2-SMI::transmission.127.1.1.4.1.3.$IFINDEX3 = Counter32: /,/g" <<< "$CORRECTED")
   UNCORRECTED=$(snmpwalk -v 2c -c $SNMP_PWD $IP .1.3.6.1.2.1.10.127.1.1.4.1.4.$IFINDEX3)
   UNCORRECTED=$(sed "s/SNMPv2-SMI::transmission.127.1.1.4.1.4.$IFINDEX3 = Counter32: /,/g" <<< "$UNCORRECTED")
   SNR=$(snmpwalk -v 2c -c $SNMP_PWD $IP .1.3.6.1.2.1.10.127.1.1.4.1.5.$IFINDEX3)
   ...
   UNERRORED=$(snmpwalk -v 2c -c $SNMP_PWD $IP .1.3.6.1.2.1.10.127.1.1.4.1.2.$IFINDEX4)
   UNERRORED=$(sed "s/SNMPv2-SMI::transmission.127.1.1.4.1.2.$IFINDEX4 = Counter32: /,/g" <<< "$UNERRORED")
   CORRECTED=$(snmpwalk -v 2c -c $SNMP_PWD $IP .1.3.6.1.2.1.10.127.1.1.4.1.3.$IFINDEX4)
   CORRECTED=$(sed "s/SNMPv2-SMI::transmission.127.1.1.4.1.3.$IFINDEX4 = Counter32: /,/g" <<< "$CORRECTED")
   UNCORRECTED=$(snmpwalk -v 2c -c $SNMP_PWD $IP .1.3.6.1.2.1.10.127.1.1.4.1.4.$IFINDEX4)
   UNCORRECTED=$(sed "s/SNMPv2-SMI::transmission.127.1.1.4.1.4.$IFINDEX4 = Counter32: /,/g" <<< "$UNCORRECTED")
   SNR=$(snmpwalk -v 2c -c $SNMP_PWD $IP .1.3.6.1.2.1.10.127.1.1.4.1.5.$IFINDEX4)
